 ...
 *
 * - Может выступать как хранилище данных в рамках текущего запроса.
 * - Можно изменять данные контекста внутри мидлваров.
 *
 * @extends Collection<mixed>
 */
class Context extends Collection
{
    public bool $repeatShouldBeHandledManually = false;
    ...
    /**
     * Проверяет, авторизован ли пользователь в приложении Яндекса.
     *
     * @return bool
     */
    ...
    /**
     * Является ли health-check запросом от Яндекса.
     *
    ...
    /**
     * Проверяет, нужно ли повторить предыдущий запрос.
     *
     * @return bool
     */
    public function shouldRepeatPreviousRequest(): bool
    {
        return (bool) array_intersect((array) 'YANDEX.REPEAT', array_keys((array) $this->get('request.nlu.intents')));
    }
}
