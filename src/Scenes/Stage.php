...
class Stage
{
    ...
    public function dispatch(?int $eventId = null): bool
    {
        ...
        $currentSceneName = $context->get("state.{$this->state}.\$scene");
    ...
    public function enter(string $sceneName): void
    {
        ...
        $oldSceneName = $context->get("state.{$this->state}.\$scene");
        ...
        $context->set("state.{$this->state}.\$scene", $sceneName);
    ...
    public function leave(): void
    {
        ...
        $context->set("state.{$this->state}.\$scene", null);
    }
}
